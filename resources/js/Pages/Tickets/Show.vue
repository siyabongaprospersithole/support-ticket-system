...
<style scoped>
.custom-button {
    @apply px-4 py-2 text-sm font-medium rounded-md shadow-sm transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500;
}

.glass-button {
    @apply flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-medium rounded-md shadow-sm transition-all duration-300 transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500;
}

.priority-badge {
    @apply px-3 py-1.5 text-sm font-medium rounded-full shadow-sm;
}
...
.animate-pop-up {
    animation: pop-up 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
}
