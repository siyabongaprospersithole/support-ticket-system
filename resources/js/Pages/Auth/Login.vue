...
<template>
    <GuestLayout>
        ...
        <div class="animate-fade-in">
            <div v-if="status" class="mb-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded animate-slide-in">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <Link v-if="canResetPassword" :href="route('password.request')" class="text-sm text-blue-600 hover:text-blue-800 transition-colors duration-200">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="text-center">
                        ...
                        <Link :href="route('register')" class="ml-2 text-sm text-blue-600 hover:text-blue-800 transition-colors duration-200">
                            Create one now
                        </Link>
                    </div>
                </div>
